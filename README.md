...
If you want to contribute then here's how to clone our repository!


### Installation

_Below is an example of how you can instruct your audience on installing and setting up our repo.

1. Get a free API Key at [https://example.com](https://example.com)
2. Clone the repo
   ```sh
   git clone https://github.com/deimie/binaryBeasts-frontend.git
   ```
...
Project Link: [Frontend](https://deimie.github.io/binaryBeasts-frontend/)
[Backend](https://binarybeasts.nighthawkcoding.ml/)
